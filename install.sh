...
warn_missing "go"        "required for gopls LSP"
warn_missing "rustc"     "required for rust-analyzer LSP"
warn_missing "cargo"     "required for rust-analyzer and blink.cmp"
warn_missing "make"      "required for telescope-fzf-native"
warn_missing "rg"        "required for fzf-lua live_grep"
